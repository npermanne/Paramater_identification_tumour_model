...
class Cell:
    ...
    def __init__(self, stage,
        ...
        self.alpha_tumor = 0.3
        self.beta_tumor = 0.03
        self.alpha_norm_tissue = 0.15
        self.beta_norm_tissue = 0.03
        self.repair_time = 9
...
class HealthyCell(Cell):
    ...
    def radiate(self, dose):
        ...
        survival_probability = math.exp(self.radiosensitivities[self.stage] * (
                    -self.alpha_norm_tissue * dose - self.beta_norm_tissue * (dose ** 2)))
...
class CancerCell(Cell):
    ...
    def radiate(self, dose):
        ...
        survival_probability = math.exp(
            self.radiosensitivities[self.stage] * (-self.alpha_tumor * dose - self.beta_tumor * (dose ** 2)))
